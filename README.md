# react-native-percentage-circle-custom
[![Twitter URL](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)]()
[![npm](https://img.shields.io/npm/v/react-native-percentage-circle-custom.svg?maxAge=2592000)]()
...
``` bash
npm i react-native-percentage-circle-custom --save

```

``` js

import PercentageCircle from 'react-native-percentage-circle-custom';
